...
const Men = () => {
  ...
  const SelectNike = () => {
    ...
    setMenSneakers(womenSneakers);
  };
  const SelectJordan = () => {
    const womenSneakers = mensneakers.filter(product => product.brand === 'Jordan');
    setMenSneakers(womenSneakers);
  };
  const SelectReebok = () => {
    const womenSneakers = mensneakers.filter(product => product.brand === 'Reebok');
    setMenSneakers(womenSneakers);
  };
  const SelectBlack = () => {
    const womenSneakers = mensneakers.filter(product => product.color === 'black');
    setMenSneakers(womenSneakers);
  };
  const SelectBlue = () => {
    const womenSneakers = mensneakers.filter(product => product.color === 'blue');
    setMenSneakers(womenSneakers);
  };
  const SelectWhite = () => {
    const womenSneakers = mensneakers.filter(product => product.color === 'white');
    setMenSneakers(womenSneakers);
  };
  const SelectBrown = () => {
    const womenSneakers = mensneakers.filter(product => product.color === 'brown');
    setMenSneakers(womenSneakers);
  };
  const SelectGreen = () => {
    const womenSneakers = mensneakers.filter(product => product.color === 'green');
    setMenSneakers(womenSneakers);
  };
  const SelectGray = () => {
    const womenSneakers = mensneakers.filter(product => product.color === 'gray');
    setMenSneakers(womenSneakers);
  };
  const SelectMulti = () => {
    const womenSneakers = mensneakers.filter(product => product.color === 'multi');
    setMenSneakers(womenSneakers);
  };
  const SelectPink = () => {
    const womenSneakers = mensneakers.filter(product => product.color === 'pink');
    setMenSneakers(womenSneakers);
  };
  const SelectOrange = () => {
    const womenSneakers = mensneakers.filter(product => product.color === 'orange');
    setMenSneakers(womenSneakers);
  };
  const SelectPurple = () => {
    const womenSneakers = mensneakers.filter(product => product.color === 'purple');
    setMenSneakers(womenSneakers);
  };
  const SelectRed = () => {
    const womenSneakers = mensneakers.filter(product => product.color === 'red');
    setMenSneakers(womenSneakers);
  };
  const SelectYellow = () => {
    const womenSneakers = mensneakers.filter(product => product.color === 'yellow');
    setMenSneakers(womenSneakers);
  };
  const SelectNewest = () => {
    const womenSneakers = mensneakers.filter(product => product.tag === 'New !');
    setMenSneakers(womenSneakers);
  };
  const SelectPriceRange25 = () => {
    const filteredSneakers = mensneakers.filter(product => product.price >= 25 && product.price <= 50);
    setMenSneakers(filteredSneakers);
  };
  const SelectPriceRange50 = () => {
    const filteredSneakers = mensneakers.filter(product => product.price >= 50 && product.price <= 100);
    setMenSneakers(filteredSneakers);
  };
  const SelectPriceRange100 = () => {
    const filteredSneakers = mensneakers.filter(product => product.price >= 100 && product.price <= 150);
    setMenSneakers(filteredSneakers);
  };
  const SelectPriceRange150 = () => {
    const filteredSneakers = mensneakers.filter(product => product.price >= 150);
    setMenSneakers(filteredSneakers);
  };

  
  const SelectReset = () => {
    const filteredSneakers = MenProducts
    setMenSneakers(filteredSneakers);
  };
  ////////////////////////////////////////////////////
  const toggleMenu = () => {
  ...
  //products
  const Products = mensneakers.map((clickedItem) =>{
    const addToCart = () =>{
